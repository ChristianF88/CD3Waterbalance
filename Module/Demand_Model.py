...
sys.path.append('C:\Users\Gerhard\Documents\NotGithub\WaterDemandModel')
sys.path.append('C:\Users\Gerhard\Documents\NotGithub\WaterDemandModel\water_demand_model')
        ...
        if self.model_selected == "Stochastic_Model":
            ...
            if dt < 3600 :
                ...
                if self.overall_time == self.simulation_start_time:
                    ...
                    self.run.newDay()
                    Demanddictionary = self.run.getDemandsAndPollutants()
