...
class Soilstoragesetup:
    ...
    def Setandwrite_attributes(self,numberofSoilstorage, starting_value_i, attributevector):
        for i in range(numberofSoilstorage+starting_value_i)[starting_value_i:]:
            ...
            self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Total_Pervious_Area"] = attributevector[i-starting_value_i][6]
            self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Van_Genuchten_Parameter_Alpha"] = attributevector[i-starting_value_i][7]
            self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Van_Genuchten_Parameter_n"] = attributevector[i-starting_value_i][8]
            self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Field_Capacity"] = attributevector[i-starting_value_i][9]
            self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Outdoor_Demand_Actual_Evapotranspiration_Ratio"] = attributevector[i-starting_value_i][10]
        ...
        for i in range(numberofSoilstorage+starting_value_i)[starting_value_i:]:
            ...
            exec '''self.line8='\\t\\t\\t\\t<parameter name="Total_Pervious_Area_[m^2]" type="double" value="'+str(self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Total_Pervious_Area"])+'"/> \\n ' '''
            exec '''self.line9='\\t\\t\\t\\t<parameter name="Van_Genuchten_Parameter_Alpha_[cm^-1]" type="double" value="'+str(self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Van_Genuchten_Parameter_Alpha"])+'"/> \\n ' '''
            exec '''self.line10='\\t\\t\\t\\t<parameter name="Van_Genuchten_Parameter_n_[-]" type="double" value="'+str(self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Van_Genuchten_Parameter_n"])+'"/> \\n ' '''
            exec '''self.line11='\\t\\t\\t\\t<parameter name="Field_Capacity_[cm_Water_Column]" type="double" value="'+str(self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Field_Capacity"])+'"/> \\n ' '''
            exec '''self.line12='\\t\\t\\t\\t<parameter name="Outdoor_Demand_Actual_Evapotranspiration_Ratio_(OutD/ActualEvapotr)_[-]" type="double" value="'+str(self.Soilstorageattributelist[i-starting_value_i][str('Soilstorage_'+str(i))]["Outdoor_Demand_Actual_Evapotranspiration_Ratio"])+'"/> \\n ' '''            
            exec '''self.line13='\\t\\t\\t</node> \\n ' '''        
